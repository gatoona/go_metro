...
function load() {
	...
	searchStation.value = "Nombre de estación";
...
function setMarkers(map, locations, category) {
	for (var i = 0; i < locations.length; i++) {
		...
		google.maps.event.addListener(marker, 'click', function() {
			...
			var dataev = this.ev;
	 stationinfoWindow.setContent('<table width="400" border="0" cellspacing="5"><tr><td width="32" align="left" valign="middle"><img src="../images/'+dataline+'.jpg" border="0"></td><td width="364" align="left" valign="middle"><font size="5"><b>'+datainfo+'</b></font><br>'+dataline+' Line</td></tr></table><table width="400" border="0" cellspacing="5"><tr><td width="30" align="left"><img src="../images/parking.png" border="0"></td><td width="351" valign="middle"><strong>Estacionamiento - Gratis: </strong>'+datafree+'<strong> | Pagado:</strong> '+datapaid+'</td></tr><tr><td align="left"><img src="../images/parking_spaces.png" border="0"></td><td valign="middle"><strong>	Estacionamiento:</strong> '+dataparking+'</td></tr><tr><td align="left"><img src="../images/bike_locker.png" border="0"></td><td valign="middle"><strong>Casilleros para bicicletas: </strong>'+datalockers+'</td></tr><tr><td align="left"><img src="../images/bike_rack.png" border="0"></td><td valign="middle"><strong>Portabicicletas: </strong>'+dataracks+'</td></tr><tr><td align="left"><img src="../images/transfer.png" border="0"></td><td valign="middle"><strong>Conexiones: </strong>'+dataconnections+'</td></tr><tr><td align="left"><img src="../images/ada.jpg" border="0"></td><td valign="middle"><strong>Accessible Entrances: </strong>'+dataada+'</td></tr><tr><td align="left"><img src="../images/ev.jpg" border="0"></td><td valign="middle"><strong>EV Estaciones de carga: </strong>'+dataev+'</td></tr></table><table border="0" width="400"><tbody><tr><td align="center"><a target="blank" href="http://www.metro.net/'+datatimetable+'"><img src="../images/horario.png" border="0"></a><a target="blank" href="http://maps.google.es/maps/'+datagmaps+'"><img src="../images/mapas_de_google.png" border="0"></a><a target="blank" href="http://www.yelp.com/search?find_desc=&amp;find_loc='+datayelp+'&amp;ns=1"><img src="../images/yelp.png" border="0"></a></td></tr></tbody></table>');
...
function HomeControl(homeControlDiv, homeControlDiv4, mapmap, map) {
	...
	google.maps.event.addDomListener(homeControlDiv, 'click', function() {
		document.getElementById("overlayToggle").innerHTML = "Mapa estándar";
		numClicked = 0;
		clearOverlays();
...
function HomeControl2(homeControlDiv, homeControlDiv4, mapmap, map) {
	// Setup the click event listeners
	google.maps.event.addDomListener(homeControlDiv, 'click', function() {
		document.getElementById("overlayToggle").innerHTML = "Mapa de Google";
